...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.With(middleware.RateLimit(rl, ratelimit.BucketStreak, logger)).Post("/gaming/streak/freeze", h.FreezeStreak)
		...
		// Boss progression map — per-user defeated/current/locked trail
		r.Get("/gaming/boss/progression", h.GetBossProgression)
